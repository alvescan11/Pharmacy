...
from Repository.Exceptii import NoSuchIDError, DuplicateIDError
...
class RepositoryInMemory(Repository):
    ...
    def adauga(self, entitate: Entitate) -> None:
        ...
        :param entitatet: obiect de tip Entitate
        :return: None
        """
    ...
    def sterge(self, id_entitate: str) -> None:
        ...
        if self.read(id_entitate) is None:
            raise NoSuchIDError("Nu exista o entitate cu ID-ul dat!")
